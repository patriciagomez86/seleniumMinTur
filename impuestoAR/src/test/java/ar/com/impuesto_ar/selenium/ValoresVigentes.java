...
public class ValoresVigentes {
	...
	public ValoresVigentes(WebDriver driver, String url) {
		this.driver = driver;
	...
	public ValoresVigentes aniadirUsuario(String nombreDeUsuario) {
		try {
	...
	public ValoresVigentes aniadirContrasenia(String contrasenia) {
		try {
	...
	public ValoresVigentes login(String nombreDeUsuario, String contrasenia) throws InterruptedException {
		try { 
	...
	public ValoresVigentes clickBtnIngreso() throws InterruptedException {
		try { 						 			
			wait.until(ExpectedConditions.elementToBeClickable(btnLoginBoton));			 
			Thread.sleep(1000);
			this.btnLoginBoton.click();
