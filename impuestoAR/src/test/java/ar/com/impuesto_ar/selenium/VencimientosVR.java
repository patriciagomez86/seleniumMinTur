...
public class VencimientosVR {
	...
	public VencimientosVR(WebDriver driver, String url) {
		this.driver = driver;
	...
	public VencimientosVR aniadirUsuario(String nombreDeUsuario) {
		try {
	...
	public VencimientosVR aniadirContrasenia(String contrasenia) {
		try {
	...
	public VencimientosVR login(String nombreDeUsuario, String contrasenia) throws InterruptedException {
		try { 
	...
	public VencimientosVR clickBtnIngreso() throws InterruptedException {
		try { 						 			
			wait.until(ExpectedConditions.elementToBeClickable(btnLoginBoton));			 
			Thread.sleep(1000);
			this.btnLoginBoton.click();
