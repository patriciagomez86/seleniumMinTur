...
public class Feriados {
	...
	public Feriados(WebDriver driver, String url) {
		this.driver = driver;
	...
	public Feriados aniadirUsuario(String nombreDeUsuario) {
		try {
	...
	public Feriados aniadirContrasenia(String contrasenia) {
		try {
	...
	public Feriados login(String nombreDeUsuario, String contrasenia) throws InterruptedException {
		try { 
	...
	public Feriados clickBtnIngreso() throws InterruptedException {
		try { 						 			
			wait.until(ExpectedConditions.elementToBeClickable(btnLoginBoton));			 
			Thread.sleep(1000);
			this.btnLoginBoton.click();
