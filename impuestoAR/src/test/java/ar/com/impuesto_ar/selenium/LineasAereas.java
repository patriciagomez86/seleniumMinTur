...
public class LineasAereas {
	...
	public LineasAereas(WebDriver driver, String url) {
		this.driver = driver;
	...
	public LineasAereas aniadirUsuario(String nombreDeUsuario) {
		try {
	...
	public LineasAereas aniadirContrasenia(String contrasenia) {
		try {
	...
	public LineasAereas login(String nombreDeUsuario, String contrasenia) throws InterruptedException {
		try { 
	...
	public LineasAereas clickBtnIngreso() throws InterruptedException {
		try { 						 			
			wait.until(ExpectedConditions.elementToBeClickable(btnLoginBoton));			 
			Thread.sleep(1000);
			this.btnLoginBoton.click();
