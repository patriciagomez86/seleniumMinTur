...
public class VencimientosCertContable {
	...
	public VencimientosCertContable(WebDriver driver, String url) {
		this.driver = driver;
	...
	public VencimientosCertContable aniadirUsuario(String nombreDeUsuario) {
		try {
	...
	public VencimientosCertContable aniadirContrasenia(String contrasenia) {
		try {
	...
	public VencimientosCertContable login(String nombreDeUsuario, String contrasenia) throws InterruptedException {
		try { 
	...
	public VencimientosCertContable clickBtnIngreso() throws InterruptedException {
		try { 						 			
			wait.until(ExpectedConditions.elementToBeClickable(btnLoginBoton));			 
			Thread.sleep(1000);
			this.btnLoginBoton.click();
